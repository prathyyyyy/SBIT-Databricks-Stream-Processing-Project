        ...
        "tasks": [
            {
                ...
                "run_if": "ALL_SUCCESS",
                "notebook_task": {
                    "notebook_path": "/Workspace/Repos/sbit-project/sbit-project/07.run-scripts",
                    "source": "WORKSPACE"
                },
...
un_payload = {"job_id": job_id, "notebook_params": {"Environment":env, "RunType": "stream", "ProcessingTime": "1 seconds"}}
